...
export default function SalesPage() {
  ...
  const generateInvoicePDF = (sale: Sale) => {
    ...
    doc.text(`Invoice No: ${sale.invoiceNo}`, 20, 50);
    doc.text(`Customer: ${sale.customer}`, 20, 65);
    ...
    doc.setFont("helvetica", "bold");
    doc.text("Invoice Summary", 25, 112);

    doc.setFont("helvetica", "normal");
    doc.text("Amount", 25, 125);

    doc.setFont("helvetica", "bold");
    doc.text(`INR ${sale.amount.toLocaleString()}`, 150, 125);
